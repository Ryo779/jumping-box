...
var game = cc.Layer.extend({
    init:function () {
        this._super();
        var backgroundLayer = cc.LayerGradient.create(cc.color(0xdf,0x9f,0x23,255),cc.color(0xfa,0xf7,0x5f,255));
        ...
        this.addBody(48,160,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(96,64,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(144,64,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(192,112,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(240,30,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(288,96,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(336,111,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(384,32,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(432,80,48,18,false,res.block_png,SpriteTag.destroyable);
        this.addBody(240,188,33,32,true,res.totem_png,SpriteTag.totem);
        this.addBody(128,176,48,18,true,res.gool_png,SpriteTag.gool);
